...
Por questões de economia de espaço, apenas é incluído o conjunto de dados original. Para utilizar a solução, há que garantir a execução do código da primeira fase, uma vez que é o responsável por gerar os conjuntos de dados necessários à execução das fases seguintes.
